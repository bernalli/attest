...
- **2026-09-09 (rev 12)**: §2 sanctions its fourteenth instance, the new reserved-root member-admission restriction (v0.1 rev 19 §14.1; v0.2 rev 14 §14). Records the newly recognized omission hazard, explicit cost for previously accepted archives, and continued acceptance of distinct future roots. Ratified before implementation; tests are red-first. — vectors: none (bundle importer tests)

- **2026-09-07 (rev 11)**: §2 gains its thirteenth sanctioned instance: v0.1 rev 18 (§12.2) requires refusal when an admitted non-empty revocation view engages an unrepresentable refund-window deadline, independently of whether a record matches. — vectors: 23-revocation-refund-window
