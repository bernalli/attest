...
- `--adapter` is a command **template** containing the literal placeholder
  ...
  shell string).
- `--subset` selects `v0.1` (66 leaves) or `v0.2` (all leaves, currently 225) —
  see §4.
...
```
CONFORMANT (v0.2): 225/225 leaves pass — corpus revision <hex12>
...
- **v0.2** — every leaf in the corpus (currently 225). Measures conformance
...
- **v0.1** — the 66-leaf subset: every leaf whose top-level group directory's
  ...
  profile) is measured against this subset, not against all 225.
...
| --- | --- | --- | --- | --- | --- |
| attest (Python reference) 0.9.3 | v0.2 | 225/225 | `374f8e3aaa4133608ee51efffe073723400a63743db2ec323016436519eec3d9` | 2026-09-07 | `uv run --frozen python tools/conformance_runner.py --adapter ".venv/bin/python tools/conformance_adapter_py.py {leaf}" --subset v0.2` |
| attest (Python reference) 0.9.3 | v0.1 | 66/66 | `374f8e3aaa4133608ee51efffe073723400a63743db2ec323016436519eec3d9` | 2026-09-07 | `uv run --frozen python tools/conformance_runner.py --adapter ".venv/bin/python tools/conformance_adapter_py.py {leaf}" --subset v0.1` |
| attest-verifier (TypeScript) 0.9.3 | v0.2 | 225/225 | `374f8e3aaa4133608ee51efffe073723400a63743db2ec323016436519eec3d9` | 2026-09-07 | `npm run build --prefix verifiers/ts && python3 tools/conformance_runner.py --adapter "node tools/conformance_adapter_ts.mjs {leaf}" --subset v0.2` |
| attest-verifier (TypeScript) 0.9.3 | v0.1 | 66/66 | `374f8e3aaa4133608ee51efffe073723400a63743db2ec323016436519eec3d9` | 2026-09-07 | `npm run build --prefix verifiers/ts && python3 tools/conformance_runner.py --adapter "node tools/conformance_adapter_ts.mjs {leaf}" --subset v0.1` |
