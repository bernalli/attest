...
only) are independent Python and TypeScript implementations that agree on all 157
...
verifier — that agree on all 157 conformance vector leaves across 40 groups: 52
...
requests must pass all 157 conformance vector leaves and keep both the Python and
