...
the corpus now contains 223 leaves, and a release may claim the §20-expanded corpus
only once both implementations reproduce all 223. **Try it in your browser:**
...
measured by the shared conformance corpus, now 223 leaves across 47 groups: 65
...
required to reject v0.2 envelopes, so it is measured against the 65-leaf
...
requests must pass all 223 conformance vector leaves and keep both the Python and
